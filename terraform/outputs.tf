...
output "instance_self_link" { value = google_compute_instance.vm.self_link }
output "internal_ip"        { value = try(google_compute_instance.vm.network_interface[0].network_ip, null) }
